...
public class CrowdViewPagerAdapter extends PagerAdapter {

	private View[] mList;
	private List<CrowdFundingEntity> datas;
	...
	public CrowdViewPagerAdapter(Context context, List<CrowdFundingEntity> vList) {
