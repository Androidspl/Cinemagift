...
public class GoodsSearch extends BaseListFragment<Goods> {
	private Context context;
	private List<Goods> goods;
	private GoodsBiz goodsBiz;
	private List<Goods> searchGoods;

	public GoodsSearch(List<Goods> goods, Context context) {
...
//		searchGoods = goodsBiz.getSearchGoods("Type", "Keyword");
//		searchGoods = goodsBiz.getSearchGoods("1", "Keyword");
		setCurrentPage(0);
